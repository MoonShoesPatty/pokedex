...
// Pull flavour text, not stored in the same API for some absurd reason
...
pokedex.displayPokemonInfo = async function(pokeNumber) {
    ...
    <div class="pokemonMatchups clearfix">
    ...
    // class & variable for use in toggling between sections "info" and "type"
